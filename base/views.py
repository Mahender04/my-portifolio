    ...
    if request.method == "POST":
        ...
        try:
            ...
            send_mail(
                ...
                f"Name: {name}\nEmail: {email}\nMessage:\n{message}",
                "mahendernampelli04@gmail.com",
                ["mahendernampelli04@gmail.com"],  # admin email
            )
    ...
    if request.method == 'POST':
        try:
            ...
            send_mail(
                ...
                from_email='mahendernampelli04@gmail.com',
                recipient_list=['mahendernampelli04@gmail.com'],
                fail_silently=False,
            )
